...
let form = document.querySelector('.main-form'),
		...
		form.addEventListener('submit', (event) => { //submit вешается на форму, а не на кнопку!!!!
		...
		console.log(request.readyState);	 // https://www.w3schools.com/xml/ajax_xmlhttprequest_response.asp
